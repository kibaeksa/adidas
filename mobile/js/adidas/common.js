...
(function ($) {
	...
	adiApp.addEventListener(document.querySelectorAll('#header .nav_menu .gnb>li'), 'click', function (e) {
		...
		if (!adiApp.hasClass(e.currentTarget, 'open')) {
			...
			var innerTop = rootTop - document.querySelector('#header .nav_menu .nav_menu_inner').getBoundingClientRect().top;
			var yVal = e.currentTarget.getBoundingClientRect().top - rootTop + innerTop;
